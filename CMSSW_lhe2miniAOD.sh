...
cd CMSSW_7_1_21/src/
cmsenv 
cmsDriver.py Configuration/Generator/python/Hadronizer_TuneCUETP8M1_13TeV_generic_LHE_pythia8_cff.py --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot NominalCollision2015 --step GEN,SIM --magField 38T_PostLS1 --filein=file:/eos/uscms/store/user/zchen/HeavyB2bX/lhe/13TeV_B2bee/tran.lhe --fileout=HeavyB2bX_13TeV_TranEE_SIM.root --python_filename=otman_instructions_gen_sim.py -n 5
...
# 3rd step: miniAOD
cmsDriver.py step2 --filein file:HeavyB2bX_13TeV_TranMuMu_AOD.root  --fileout file:HeavyB2bX_13TeV_TranMuMu_miniAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_miniAODv2_v0 --step PAT --era Run2_25ns -n 5
