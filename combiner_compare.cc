...
#define TransverseFILE      "BeforeCut/NCFC_8TeV/tran.root"
#define LongitudinalFILE    "BeforeCut/NCFC_8TeV/long.root"
#define ScalarFILE          "BeforeCut/NCFC_8TeV/scal.root"

#define TransverseFILE2      "AfterbMuCut/NCFC_8TeV/tran.root"
#define LongitudinalFILE2    "AfterbMuCut/NCFC_8TeV/long.root"
#define ScalarFILE2          "AfterbMuCut/NCFC_8TeV/scal.root"
...

{
    ...
    playground2->Divide(2,2);
      ...
      playground2->cd(4);
        ...
        TH1F *Tran2 = (TH1F*)TransverseRootFile2.Get("DeltaPhi");
        TH1F *Long2 = (TH1F*)LongitudinalRootFile2.Get("DeltaPhi");
        TH1F *Scal2 = (TH1F*)ScalarRootFile2.Get("DeltaPhi");
    ...
    playground3->Divide(1,3);
        ...
        TH1F *Tran2 = (TH1F*)TransverseRootFile2.Get("IMass2");
        TH1F *Long2 = (TH1F*)LongitudinalRootFile2.Get("IMass2");
        TH1F *Scal2 = (TH1F*)ScalarRootFile2.Get("IMass2");
